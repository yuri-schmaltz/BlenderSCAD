    ...
    def invoke(self, context, event):
        ...
        for o in change:
            ...
            if root != o:  # real root
                # print (("root=",root,"o=",o));
                o.select = False
                root.select = root not in oldsel
                # toggle selection
            else:
                o.select = o not in oldsel
                # toggle selection
...
class VIEW3D_OT_blenderscad_multiselect(bpy.types.Operator):
    ...
    bl_description = (
        "Override select behaviour to 'toggle' to  allow for multi-object-selections"
    )
    ...
    def execute(self, context):
        ...
        for item in keyMap.keymap_items:
            ...
            if [item.name, item.idname, item.map_type, item.type, item.propvalue] == [
                "Activate/Select",
                "view3d.select",
                "MOUSE",
                "SELECTMOUSE",
                "NONE",
            ] and [item.any, item.shift, item.ctrl, item.alt, item.oskey] == [
                False,
                False,
                False,
                False,
                ...
                setattr(
                    item.properties,
                    "toggle",
                    False == getattr(item.properties, "toggle"),
                )
                # dict(item.properties)
                # item.active=False
        return {"FINISHED"}
...
class VIEW3D_OT_blenderscad_colorTEST(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        #######################
        blenderscad.core.apply2objects(
            bpy.context.selected_objects, colorize_func, True
        )
        return {"FINISHED"}
...
class VIEW3D_OT_blenderscad_hole(bpy.types.Operator):
    bl_label = "hole"
    bl_idname = "view3d.blenderscad_hole"
    bl_description = (
        "Declare selected objects/groupings as being 'holes' in future groupings"
    )
...
class VIEW3D_OT_blenderscad_group(bpy.types.Operator):
    bl_label = "group"
    bl_idname = "view3d.blenderscad_group"
...
class VIEW3D_OT_blenderscad_ungroup(bpy.types.Operator):
    bl_label = "ungroup"
    bl_idname = "view3d.blenderscad_ungroup"
...
class VIEW3D_OT_blenderscad_subdivide(bpy.types.Operator):
    bl_label = "subdivide"
    bl_idname = "view3d.blenderscad_subdivide"
...
class VIEW3D_OT_blenderscad_beautify(bpy.types.Operator):
    bl_label = "remesh"
    bl_idname = "view3d.blenderscad_beautify"
...
class VIEW3D_OT_blenderscad_dissolve(bpy.types.Operator):
    bl_label = "dissolve"
    bl_idname = "view3d.blenderscad_dissolve"
...
class VIEW3D_OT_blenderscad_round(bpy.types.Operator):
    bl_label = "round"
    bl_idname = "view3d.blenderscad_round"
...
class VIEW3D_OT_blenderscad_decimate(bpy.types.Operator):
    bl_label = "decimate"
    bl_idname = "view3d.blenderscad_decimate"
...
class VIEW3D_OT_blenderscad_hull(bpy.types.Operator):
    bl_label = "hull"
    bl_idname = "view3d.blenderscad_hull"
...
class VIEW3D_OT_blenderscad_debug(bpy.types.Operator):
    bl_label = "debug"
    bl_idname = "view3d.blenderscad_debug"
...
class VIEW3D_OT_blenderscad_difference(bpy.types.Operator):
    bl_label = "difference"
    bl_idname = "view3d.blenderscad_difference"
...
class VIEW3D_OT_blenderscad_intersection(bpy.types.Operator):
    ...
    bl_idname = "view3d.blenderscad_intersection"
...
class VIEW3D_OT_blenderscad_union(bpy.types.Operator):
    bl_label = "union"
    bl_idname = "view3d.blenderscad_union"
...
class VIEW3D_OT_blenderscad_clone(bpy.types.Operator):
    bl_label = "clone"
    bl_idname = "view3d.blenderscad_clone"
...
class VIEW3D_OT_blenderscad_destruct(bpy.types.Operator):
    bl_label = "destruct"
    bl_idname = "view3d.blenderscad_destruct"
...
class VIEW3D_PT_blenderscad_qat(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col2.operator(
            "mesh.primitive_uv_sphere_add", text="Sphere", icon="MESH_UVSPHERE"
        )
        ...
        col.operator(
            "view3d.blenderscad_multiselect", text="MultiSelect", icon="STICKY_UVS_LOC"
        )
        ...
        col.operator(
            "view3d.blenderscad_dissolve", text="CleanUp", icon="SAVE_PREFS"
        )  # MOD_BOOLEAN
        col.operator(
            "view3d.blenderscad_round", text="Round", icon="MOD_BEVEL"
        )  # MOD_BOOLEAN
        ...
        col.operator(
            "view3d.blenderscad_subdivide", text="Subdivide", icon="OUTLINER_OB_LATTICE"
        )

        col2.operator(
            "view3d.blenderscad_hole", text='"Hole"', icon="UGLYPACKAGE"
        )  # TODO: better icon for "hole"
        col2.operator("view3d.blenderscad_group", text="Group", icon="GROUP")
        col2.operator(
            "view3d.blenderscad_ungroup", text="UnGroup", icon="STICKY_UVS_DISABLE"
        )
        ...
        col2.operator(
            "view3d.blenderscad_difference", text="Difference", icon="ROTACTIVE"
        )
        col2.operator(
            "view3d.blenderscad_intersection", text="Intersect", icon="ROTATECENTER"
        )
...
class VIEW3D_MT_blenderscad(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator(
            "view3d.blenderscad_debug", text="ShowEdges", icon="WIRE"
        )  # WIRE
        layout.operator(
            "view3d.blenderscad_dissolve", text="CleanUp", icon="SAVE_PREFS"
        )  # MOD_BOOLEAN
        ...
        layout.operator(
            "view3d.blenderscad_decimate", text="Decimate", icon="MOD_DECIM"
        )
        layout.operator(
            "view3d.blenderscad_beautify", text="Beautify", icon="SCENE_DATA"
        )
        layout.operator(
            "view3d.blenderscad_subdivide", text="Subdivide", icon="OUTLINER_OB_LATTICE"
        )
        ...
        layout.operator(
            "view3d.blenderscad_union", text="Union", icon="ROTATECOLLECTION"
        )
        layout.operator(
            "view3d.blenderscad_difference", text="Difference", icon="ROTACTIVE"
        )
...
def default_keymap(enable=False):
    keyMap = bpy.context.window_manager.keyconfigs.active.keymaps[
        "3D View"
    ...
    for item in keyMap.keymap_items:
        ...
        if [item.name, item.idname, item.map_type, item.type, item.propvalue] == [
            ...
            # print("BINGO!");
            setattr(
                item.properties, "toggle", False == getattr(item.properties, "toggle")
            )
            # dict(item.properties)
            item.active = enable
            return item
...
def register():
    ...
    kmi = km.keymap_items.new(
        VIEW3D_OT_blenderscad_select_bsgroup.bl_idname,
        "SELECTMOUSE",
        "PRESS",
        ctrl=False,
        shift=False,
